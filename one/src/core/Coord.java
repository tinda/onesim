...
public class Coord implements Cloneable, Comparable<Coord> {
	 ...
	 * 
	 * @param dx
	 *            How much to move the point in X-direction
	 * @param dy
	 *            How much to move the point in Y-direction
	 */
	...
	/**
	 * Returns a hash code for this coordinate (actually a hash of the String
	 * made of the coordinates)
	 */
	public int hashCode() {
		return (x + "," + y).hashCode();
	}
	...
	/**
	 * Compares this coordinate to other coordinate. Coordinate whose y value is
